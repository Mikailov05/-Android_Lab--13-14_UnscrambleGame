...
class GameViewModelTest {
    ...
    private fun getUnscrambledWord(scrambledWord: String): String {
        return com.mikailov.unscramblegame.data.allWords.firstOrNull { word ->
